...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("img/favicon.png", __ASSET__img_favicon_png);
		type.set ("img/favicon.png", AssetType.IMAGE);
...
@:keep @:bind #if display private #end class __ASSET__img_favicon_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/img/favicon.png") #if display private #end class __ASSET__img_favicon_png extends lime.graphics.Image {}
